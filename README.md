...
- MacBook  Pro
  ( Processor:  Intel  Core  i9,  2.4GHz  octa-core,
   Ram:  32GB  2667  MHz  DDR4,
   OS:  macOS  Catalina(10.15.7) )
- MacBook  Air
  ( Processor:  Intel  Core  i5,  1.6GHz  dual-core,
  Ram:  4GB  1600MHz  DDR4,
  OS:  macOS  Catalina(10.15.7) )    
- Dell  XPS  15  9570
  ( Processor:  Intel  Core  i7-8750h,  2.20GHz,
  Ram:  16GB  2208MHz  DDR4,
  OS: Windows 10(10.0.18363 Numero 18363) )
...
## Conclusion: Discussion (향후 계획, 발전 방향, 데모 링크)
